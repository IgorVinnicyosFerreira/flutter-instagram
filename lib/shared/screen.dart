...
import 'package:flutter/material.dart';
  ...
  double width({@required String percent , @required BuildContext context, double max = 0.0, double min = 0.0}){
  ...
  double height({@required String percent , @required BuildContext context, double max = 0.0, double min = 0.0}){
